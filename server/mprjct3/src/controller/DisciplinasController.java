...
public class DisciplinasController {
    ...
    public Response trial(@PathParam("intext") String intext) {
        List disciplinas = Queries.queryCustomLike("Disciplina", "nome", intext);
    ...
    public Response example(@PathParam("nome") String nome) {
        List disciplinas = Queries.queryCustom("Disciplina", "nome", nome, true);
    ...
    public Response setHorarios(List<Disciplina> allDis) throws Exception {
        ...
        for (Disciplina dis : allDis) {
            ...
            List department = Queries.queryCustom("Departamento", "codigo", String.valueOf(allDis.get(0).getDepartamento().getCodigo()), false);
