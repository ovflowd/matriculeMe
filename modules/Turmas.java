...
public class Turmas {
	...
	private Professores professor;//'FK' Referência ao professor que ministrará a disciplina
	
	@Column
	private int campus;//qual unidade regional da universidade a disciplina é ofertada
